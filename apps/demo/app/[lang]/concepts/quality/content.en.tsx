    ...
    <div className="doc">
      ...
      <div className="tableWrap">
        <table>
          ...
          <tbody>
            <tr><td>Decision table</td><td>the app-first pack verified as an exhaustive 45-cell table - 3 roles x 3 sizes x 3 inputs. Editing the policy means consciously editing the table; the table is the documentation.</td></tr>
